...
This repository contains scripts for processing NAIP imagery for use with [UrbanWatch](https://urbanwatch.charlotte.edu/) software.

## Citation:
Please cite the following paper when using UrbanWatch:
